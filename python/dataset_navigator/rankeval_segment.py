...
def kendall_tau(predicted_rank_vector, original_rank_vector, **kwargs):
    ...
    Result = namedtuple('Result',
                        ['tau', 'prob', 'concordant_count', 'discordant_count', 'all_pairs_count', 'original_ties',
                         'predicted_ties', 'pairs'])
    result = Result(tau, prob, concordant_count, discordant_count, all_pairs_count, original_ties, predicted_ties,
                    pairs)
